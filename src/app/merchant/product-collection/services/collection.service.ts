...
import { Collection as ComponentEntity } from '../entities/collection.entity';

const COMPONENT_URL = 'collections/';
...
export class CollectionService {
  ...
  listMerchantCollections(
    merchantId: string = 'me'
  ): Observable<HttpResponse<ComponentEntity[]>> {
    return this.http.get<ComponentEntity[]>(
      `${this.baseURL}${COMPONENT_URL}list_collections_merchant/`,
      {
